...
// Block for add
   ...
   exec_time_1 = (time_2.tv_sec - time_1.tv_sec);
   exec_time_1 = exec_time_1 + (time_2.tv_nsec - time_1.tv_nsec)/1.0e9;

   info->exec_time_1 = exec_time_1;
//
...
// Block for sub
   ...
   exec_time_2 = (time_2.tv_sec - time_1.tv_sec);
   exec_time_2 = exec_time_2 + (time_2.tv_nsec - time_1.tv_nsec)/1.0e9;

   info->exec_time_2 = exec_time_2;
//
...
// Block for mul
   ...
   exec_time_3 = (time_2.tv_sec - time_1.tv_sec);
   exec_time_3 = exec_time_3 + (time_2.tv_nsec - time_1.tv_nsec)/1.0e9;

   info->exec_time_3 = exec_time_3;
//
...
// Block for div
   ...
   exec_time_4 = (time_2.tv_sec - time_1.tv_sec);
   exec_time_4 = exec_time_4 + (time_2.tv_nsec - time_1.tv_nsec)/1.0e9;

   info->exec_time_4 = exec_time_4;
//
